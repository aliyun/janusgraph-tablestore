...
import static org.janusgraph.diskstorage.tablestore.TableStoreStoreManager.defaultColumnFamilyNameBytes;
 ...
 */
public class TableStoreKeyColumnValueStore implements KeyColumnValueStore {

    private static final Logger logger = LoggerFactory.getLogger(TableStoreKeyColumnValueStore.class);

    private final TableName tableName;
    private final TableStoreStoreManager storeManager;
    ...
    private final byte[] columnFamilyBytes = defaultColumnFamilyNameBytes;

    TableStoreKeyColumnValueStore(TableStoreStoreManager storeManager, Connection cnx, TableName tableName, String storeName) {
