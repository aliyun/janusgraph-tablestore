...
//@Testcontainers
public class TableStoreGraphTest extends JanusGraphTest {
//    @Container
    ...
    @Override @Test @Disabled("TableStore does not support retrieving cell TTL by client")
    public void testVertexTTLImplicitKey() { }

    @Override @Test @Disabled("TableStore does not support retrieving cell TTL by client")
    public void testEdgeTTLImplicitKey() { }

    @Override @Test @Disabled("tmp disable")
