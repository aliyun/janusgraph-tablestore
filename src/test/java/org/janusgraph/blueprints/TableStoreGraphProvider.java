 ...
 */
public class TableStoreGraphProvider extends AbstractJanusGraphProvider {
    private static final Logger logger = LoggerFactory.getLogger(TableStoreGraphProvider.class);
    public static final TableStoreContainer HBASE_CONTAINER;
